...
scene-parse is a JSR package for parsing data from releases like torrents, scene releases, etc.

The library provides a lot of functions and definitions for things like Codec support.
...
parseTitle("Incredible.Show.That.You.Totally.Need.Parsed.1995.S03.Web-DL-iNCREDiBLE.GROUP") // Outputs as much data as it can parse from the title
```
